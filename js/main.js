...
/* harmony import */ var _components_tooltip__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_tooltip__WEBPACK_IMPORTED_MODULE_1__);
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".products__swiper", {
  slidesPerView: 4,
  spaceBetween: 42,
  pagination: {
...
infoHints.forEach(e => e.addEventListener("click", el => {
  el.stopPropagation();
}));
